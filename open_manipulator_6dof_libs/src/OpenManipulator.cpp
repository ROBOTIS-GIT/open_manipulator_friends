...
void OPEN_MANIPULATOR::initManipulator(bool using_platform, STRING usb_port, STRING baud_rate, float control_loop_time)
{
  ...
  addJoint("joint3", // my name
           "joint2", // parent name
           "joint4", // child name
           RM_MATH::Vector3(0.0, 0.0, 0.124), // relative position
           RM_MATH::convertRPYToRotationMatrix(0.0, 0.0, 0.0), // relative orientation
           Y_AXIS, // axis of rotation
           13,     // actuator id
  ...
  addJoint("joint4", // my name
           "joint3", // parent name
           "joint5",   // child name
           RM_MATH::Vector3(0.0, 0.0, 0.045), // relative position
           RM_MATH::convertRPYToRotationMatrix(0.0, 0.0, 0.0), // relative orientation
           Z_AXIS, // axis of rotation
           14,     // actuator id
           M_PI,   // max joint limit (3.14 rad)
  ...
  addJoint("joint6", // my name
           "joint5", // parent name
           "gripper",   // child name
           RM_MATH::Vector3(0.0, 0.0, 0.0475), // relative position
           RM_MATH::convertRPYToRotationMatrix(0.0, 0.0, 0.0), // relative orientation
           Z_AXIS, // axis of rotation
           16,     // actuator id
           M_PI,    // max joint limit (3.14 rad)
  ...
  addTool("gripper",   // my name
          "joint6", // parent name
          RM_MATH::Vector3(0.0, 0.0, 0.115), // relative position
          RM_MATH::convertRPYToRotationMatrix(0.0, 0.0, 0.0), // relative orientation
          17,     // actuator id
